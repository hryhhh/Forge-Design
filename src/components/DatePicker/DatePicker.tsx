  ...
  return (
    <div className="forge-datepicker-panel">
      <div className="forge-datepicker-header">
        ...
        <span className="forge-datepicker-month">{year}年{month + 1}月</span>
...
const DatePicker: React.FC<DatePickerProps> = props => {
  ...
  return (
    <div ref={containerRef} className={classNames('forge-datepicker', className, sizeClass, { 'forge-datepicker--disabled': disabled, 'forge-datepicker--open': open })} style={style}>
