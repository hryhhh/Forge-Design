...
describe('Checkbox Component', () => {
  it('should render basic checkbox', () => {
    ...
    expect(container.querySelector('.forge-checkbox-label')).toHaveTextContent(
      '选项'
    )
  })
  ...
  it('should support checked prop', () => {
    ...
    expect(input.checked).toBe(true)
    expect(
      container.querySelector('.forge-checkbox--checked')
    ).toBeInTheDocument()
  })
  ...
  it('should support size prop', () => {
    ...
    expect(
      container.querySelector('.forge-checkbox--large')
    ).toBeInTheDocument()
  })
  ...
  it('should support disabled state', () => {
    ...
    expect(
      container.querySelector('.forge-checkbox--disabled')
    ).toBeInTheDocument()
  })
  ...
  it('should support indeterminate', () => {
    ...
    expect(
      container.querySelector('.forge-checkbox--indeterminate')
    ).toBeInTheDocument()
  })
  ...
  it('should support Checkbox.Group size prop', () => {
    const { container } = render(
      <Checkbox.Group size="large" options={[{ value: 'a', label: '选项A' }]} />
    )
    expect(
      container.querySelector('.forge-checkbox-group--large')
    ).toBeInTheDocument()
  })
  ...
  it('should support Checkbox.Group direction vertical', () => {
    ...
    expect(
      container.querySelector('.forge-checkbox-group--vertical')
    ).toBeInTheDocument()
  })
  ...
  it('should support Checkbox.Group optionType button', () => {
    ...
    expect(
      container.querySelector('.forge-checkbox-group--button')
    ).toBeInTheDocument()
    expect(
      container.querySelector('.forge-checkbox-button')
    ).toBeInTheDocument()
  })

  it('should support autoFocus', () => {
    const { container } = render(
      <Checkbox.Group autoFocus options={[{ value: 'a', label: '选项A' }]} />
    )
