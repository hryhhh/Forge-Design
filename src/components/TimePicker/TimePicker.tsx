...
const TimePanel: React.FC<{
...
}> = ({ value, onChange, showSecond = true, disabledHours, disabledMinutes, disabledSeconds, hideDisabledOptions }) => {
  ...
  const [activeColumn, setActiveColumn] = useState<'hour' | 'minute' | 'second'>('hour')
  ...
  const Column = ({ items, selected, disabled, onChange, label }: {
    items: number[]
    selected: number
...
const TimePicker: React.FC<TimePickerProps> = props => {
  ...
  return (
    <div ref={containerRef} className={classNames('forge-timepicker', className, sizeClass, { 'forge-timepicker--disabled': disabled, 'forge-timepicker--open': open })} style={style}>
