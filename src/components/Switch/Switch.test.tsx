...
describe('Switch Component', () => {
  ...
  it('should support defaultChecked', () => {
    ...
    expect(container.querySelector('.forge-switch--checked')).toBeInTheDocument()
  })
  ...
  it('should support unchecked', () => {
    ...
    expect(container.querySelector('.forge-switch--checked')).not.toBeInTheDocument()
  })
  ...
  it('should support disabled state', () => {
    ...
    expect(container.querySelector('.forge-switch--disabled')).toBeInTheDocument()
  })
  ...
  it('should support loading state', () => {
    ...
    expect(container.querySelector('.forge-switch--loading')).toBeInTheDocument()
  })
  ...
  it('should support checkedChildren and unCheckedChildren', () => {
    ...
    expect(container.querySelector('.forge-switch-unchecked-content')).toHaveTextContent('关')
  })
